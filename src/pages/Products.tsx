...
const wheatProducts = [
  {
    id: 'GrandMills-harees-wheat',
    name: 'GrandMills Harees Wheat',
  ...
  },
  {
    ...
    name: 'Noora Golden Star Chakki Atta',
    image: grandMillsChakkiImg,
    description: 'Stone-ground whole wheat flour by Noora that retains natural bran and nutrients, perfect for making soft, fluffy rotis and chapatis.',
    features: ["Stone-Ground (Chakki)", "100% Whole Wheat", "Rich in Fiber", "For Soft Rotis"]
  },
  {
    id: 'grand-mills-chappati-atta',
    name: 'GrandMills Chappati Atta',
...
const testimonialsData = [
    {
      quote: "The softness and consistency of Ferrari Foods’ wheat flour have transformed our bakery products. From bread to pastries, the quality is unmatched. Our customers instantly notice the difference.",
      name: 'Leading Bakery in Dubai',
      title: 'Executive Chef, The Royal Palm Group, Dubai',
      stars: 5,
    },
    {
      quote: "As a trusted foodstuff distributor, reliability and supply consistency are critical. Ferrari Foods has never let us down. Their premium rice and wheat products arrive on time, every time, with top-class packaging.",
      name: 'Foodstuff Trading Company, UAE',
      title: 'Procurement Director, Global Food Imports',
      stars: 5,
    },
    {
      quote: "Our biryani and rice-based dishes owe their signature taste to Ferrari Foods’ premium basmati rice. The aroma and long grains set us apart from competitors. Truly a partner in our culinary success.",
...
// --- UPDATED STICKY PRODUCT SHOWCASE COMPONENT ---
